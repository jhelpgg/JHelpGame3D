 ...
 * @author JHelp
 */
public class CharacterHumanFemale
      extends CharacterHuman
{
   ...
   {
      if(CharacterHumanFemale.allCharacter != null)
      {
         return Tool3D.createCloneHierarchy(CharacterHumanFemale.allCharacter);
      }

      CharacterHumanFemale.allCharacter = new Node();

      // Load the head
      final VirtualBox box = CharacterHuman.addHumanHeadTo(CharacterHumanFemale.allCharacter);
      ...
      body.appendLine(new Point2D(maxWidth, height * 0.4f), new Point2D(hipWidth, height * 0.75f));
      body.appendLine(new Point2D(hipWidth, height * 0.75f), new Point2D(maxWidth, height));
      ...
      CharacterHumanFemale.allCharacter.addChild(body);
      ...
      rightHarmHigh.setPosition(-maxWidth, height * 0.45f, 0);
      ...
      leftHarmHigh.setPosition(maxWidth, height * 0.45f, 0);
      ...
      // END
      CharacterHumanFemale.allCharacter.centerGravityPoint();
      return CharacterHumanFemale.allCharacter;
   }

   /**
    * Create a new instance of CharacterHumanFemale
    */
   public CharacterHumanFemale()
   {
      super(CharacterHumanFemale.obtainCharacter());
      this.setRightEye(EyesTexture.EYE_BLUE);
      this.setLeftEye(EyesTexture.EYE_BLUE);
      this.setHairColor(JHelpConstantsSmooth.COLOR_YELLOW_0400);
   }
}